...
export { adaptV1Expert, adaptV1Scenario, adaptV1ScenarioTeamTemplate, buildLegacyDomainPack, migrateDomainPack, compileV1ScenarioExecutionPlan, builtinLegacyPack, loadBuiltinLegacyPack } from './compat.ts'
