...
- 原有：bk-002 / bk-018 / bk-019 / bk-031 / bk-033（居住服务与经纪）+ e08-08 难而正确君（贝壳创始人）+ e04-05 一濛（长租资管）
- 新增：
  - 商业与平台经济：s-07 组织一号位（组织/商业模式创新）、s-13 斗嘴金主（单位经济/网络效应）、s-23 出行老舰长（双边平台/运营执行）
  - 政策治理（引用须标注前任/原任身份与观点时点）：bk-016 结构老市长、bk-027 稳心会长、bk-028 好房子工匠
