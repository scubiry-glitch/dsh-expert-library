...
- soft_groups: `1`
- advisory_groups: `2`
- full_report: `/root/zhijian/dsh-expert-library/work/研报交付_20260829_房地产信贷新政点评/deck_v54_pro/validation/structure_precheck/history/structure_precheck_20260830_133544.json`

## Must Fix Before Milestone

### `layout.overlap.object_overlap` × 2
...
- slide 15 | shape 28 | shape_text

### `layout.text_fit.bounds_overflow` × 3

文本估计边界已经越出可用内容区，存在明确的文本框 fit 失败风险。

suggested_fix: 增加文本框高度、减少文案密度，或把内容拆到更多卡片 / 更多页。

actual_values: 10.5pt×3

sample_locations:
- slide 19 | shape 8 | table_cell
