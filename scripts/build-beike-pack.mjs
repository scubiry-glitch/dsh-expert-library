...
${metas.length} 位贝壳生态相关专家（交叉投影：BK 居住服务派 5 位 + 难而正确君 e08-08 +
新药参谋 e04-05），由 \`scripts/build-beike-pack.mjs\` 确定性生成（复用 zhijian/bank
...
- 知识库：\`beike.99wiki\`（本地 99wiki 的 projects/贝壳x江苏银行、贝壳合作方案、
  VLC租房平台 + feishu 贝壳纪要）。
- 口径：贝壳成出口径（bk-031 挂牌哨探）与克而瑞/中指/统计局均有差异，须标注；
  挂牌哨探 bk-031 为内测对比项，对外交付不引用。
